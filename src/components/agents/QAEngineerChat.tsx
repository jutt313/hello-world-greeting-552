...
import { TestTube, Send, Bot, User, Loader2, Target } from 'lucide-react';
...
interface QAEngineerChatProps {
  projectId: string;
  projectName: string;
}

const QAEngineerChat: React.FC<QAEngineerChatProps> = ({
  projectId,
  projectName,
}) => {
  ...
  const fetchChatHistory = async () => {
    try {
      ...
      const transformedMessages: ChatMessage[] = (data || []).map(msg => ({
        id: msg.id,
        content: msg.content,
        sender_type: msg.sender_agent_id === 'qa_engineer' ? 'agent' : msg.sender_type as 'user' | 'agent',
      ...
      <CardContent className="flex-1 flex flex-col gap-4 p-4">
          ...
          <div className="space-y-4">
            {messages.length === 0 && (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <h3 className="font-semibold mb-2">Welcome to QA Engineer Agent</h3>
                <p className="text-sm">
                  I'm your quality assurance specialist, ready to ensure your software meets the highest 
                  standards through comprehensive testing strategies, automated frameworks, and quality validation.
                </p>
              </div>
            )}
              ...
              <div className="flex gap-3 justify-start">
                ...
                <div className="bg-muted rounded-lg px-4 py-2">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    QA Engineer is analyzing and creating quality assurance strategy...
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="flex gap-2">
          <Input
            ...
            placeholder="Describe your testing requirements or ask about quality assurance..."
            disabled={isLoading}
            className="flex-1"
          />
          <Button 
        ...
        <div className="text-xs text-muted-foreground text-center">
          QA Engineer Agent uses your project's selected LLM provider for intelligent testing strategies.
          All conversations are stored and used for continuous quality improvement.
        </div>
      </CardContent>
    </Card>
  );
